...
MONGODB_CONNECTION_STRING = "mongodb://farelli:shakti@ac-mrep1ay-shard-00-00.kxxqxff.mongodb.net:27017,ac-mrep1ay-shard-00-01.kxxqxff.mongodb.net:27017,ac-mrep1ay-shard-00-02.kxxqxff.mongodb.net:27017/?ssl=true&replicaSet=atlas-afnrt3-shard-0&authSource=admin&retryWrites=true&w=majority"
...
def get_post():
    ...
    try:
        ...
        return jsonify({'result':'success', 'msg':'Loading finished', 'posts': posts})
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for("home"))
...
def update_like():
    ...
    try:
        ...
        return jsonify({'result':'success', 'msg':'Liked', 'count':count})
    except (jwt.ExpiredSignatureError, jwt.exceptions.DecodeError):
        return redirect(url_for("home"))
